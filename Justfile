...
generate-bindings:
    nix run nixpkgs#rust-bindgen -- ./crates/ps2sdk-sys/wrapper.h -o ./crates/ps2sdk-sys/src/bindings.rs --use-core -- -I$PS2SDK/common/include -I$PS2SDK/ee/include -D_EE -target mips64el-none-elf 